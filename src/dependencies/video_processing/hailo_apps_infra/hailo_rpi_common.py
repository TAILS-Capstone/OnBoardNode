...
import threading
import subprocess
from dependencies.video_processing.hailo_apps_infra.gstreamer_app import (
    app_callback_class
)
...
def get_default_parser():
    ...
    parser.add_argument("--headless", "-H", action="store_true", help="Force headless (use fakesink) even if DISPLAY is set")
    return parser
